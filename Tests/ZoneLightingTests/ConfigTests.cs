...
namespace ZoneLightingTests
{
    public class ConfigTests
    {
		...
		public void SerializeZones_SerializesZonesInCorrectFormat()
		{
			...
			((FadeCandyZone) zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone1"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 6, fcChannel);
			...
			((FadeCandyZone)zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone2"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 12, fcChannel);
        ...
        public void DeserializeProgramSets_DeserializesProgramSetsAndBringsThemToInitialConditions()
        {
            ...
            ((FadeCandyZone)zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone1"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 6, fcChannel);
            ((FadeCandyZone)zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone2"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 12, fcChannel);
            ((FadeCandyZone)zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone3"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 12, fcChannel);
            ((FadeCandyZone)zones.Add(new FadeCandyZone(FadeCandyController.Instance, "TestZone4"))).AddFadeCandyLights(PixelType.OPCRGBPixel, 12, fcChannel);
